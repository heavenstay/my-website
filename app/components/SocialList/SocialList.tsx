...
export default function SocialList() {
  return (
    <div className={styles.socialList}>
      <SocialButton
        href="https://www.linkedin.com/in/even-soulard/"
        icon={
      ...
      />
      <SocialButton
        href="https://github.com/heavenstay"
        icon={
      ...
      />
      <SocialButton
        href="https://onleveling.substack.com/"
        icon={
      ...
      />
      <SocialButton
        href="https://www.upwork.com/freelancers/~016128f4344640e4c8"
        icon={
        ...
        title="Complete your project with me"
      />
      <hr />
      <SocialButton
        href="mailto:even.soulard.pro@icloud.com"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
