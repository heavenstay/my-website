...
export default function SocialList() {
  return (
    <div className={styles.socialList}>
        <a className={styles.socialButton} href="https://www.linkedin.com/in/even-soulard/">
        ...
        <a className={styles.socialButton} href="https://github.com/heavenstay">
        ...
        <a className={styles.socialButton} href="https://onleveling.substack.com/">
        ...
        <a className={styles.socialButton} href="https://www.upwork.com/freelancers/~016128f4344640e4c8">
          ...
          <span>Complete your project with me</span>
        </a>

        <hr />

        <a className={styles.socialButton} href="mailto:even.soulard.pro@icloud.com">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
